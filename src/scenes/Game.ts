...
export default class Game extends Phaser.Scene {
  ...
  create() {
    ...
    body.setVelocityX(this.baseVelocityX);
  ...
  /**
   * @param t - Time elapsed since game started.
  ...
  private handleOverlapLaser(
    ...
    if (obj2 instanceof RocketMouse) {
      obj2.kill();
    }
  }
  ...
  private handleCoinCollection(
    ...
    if (mouseState === MouseState.Running) {
      ...
      const body = this.mouse.body as Phaser.Physics.Arcade.Body;
      const velocity = this.baseVelocityX + this.score * 20;
